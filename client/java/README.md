...
FastAPI
- API version: 0.1.0
  - Build date: 2023-03-05T17:05:35.753622+08:00[Asia/Kuala_Lumpur]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**getModelsApiModelsGet**](docs/DefaultApi.md#getModelsApiModelsGet) | **GET** /api/models | Getmodels
...
## Documentation for Models
 ...
 - [ResponseGetmodelsApiModelsGet](docs/ResponseGetmodelsApiModelsGet.md)
